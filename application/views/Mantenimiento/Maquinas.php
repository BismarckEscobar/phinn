...
<main class="mdl-layout__content mdl-color--grey-100">
    <div class="contenedor">
        <div class="container">
            <div class="Buscar row column noMargen">
                ...
                <div class="input-field col s12 m6 l4">
                    <input  id="Buscar" type="text" placeholder="Buscar" class="validate">
        ...
        <div>
            <div class="right row">
                <div id="crearMaq" class="col s1 m1 l1">
...
<div id="Maquinasmodal" class="modal1" style="height:400px;">
    <div class="modal-content">
        ...
        <div class="row">
            <div class="center">
                <a href="#" onclick="GuardarMaquina()" class="btn waves-effect waves-light purple darken-2">GUARDAR</a>
                <a href="#" onclick="cerrarModalMaq()" class="btn waves-effect waves-light purple darken-2">CERRAR <i class="material-icons">close</i></a>
            </div>
        </div>
        </form>
    </div>
